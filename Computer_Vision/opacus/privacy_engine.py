...
from opacus.optimizers import DPOptimizer, get_optimizer_class, LMODPOptimizer, LapOptimizer, LapBiasOptimizer
...
class PrivacyEngine:
    ...
    def _prepare_optimizer(
        ...
        **kwargs,
        ...
        elif "laplace" in str(type(self.accountant)):
           optim_class = get_optimizer_class(
              clipping=clipping,
              distributed=distributed,
              grad_sample_mode=grad_sample_mode,
        ...
        elif "LB" in str(type(self.accountant)):
          optim_class = get_optimizer_class(
              clipping=clipping,
              distributed=distributed,
              grad_sample_mode=grad_sample_mode,
    ...
    def make_private(
        ...
        **kwargs,
        ...
        elif "Lap" in str(type(self.accountant)):
          optimizer.make_noise(self.args)
        elif "LB" in str(type(self.accountant)):
          optimizer.make_noise(self.args)
        if grad_sample_mode == "ghost":
        ...
        **kwargs,
        ...
        Returns:
            ...
            DataLoader is a brand new DataLoader object, constructed to behave as
                ...
                sampling mechanism. Points to the same dataset object.
        """
        if "PLRV" in str(type(self.accountant)) or "Lap" in str(type(self.accountant)) or "LB" in str(type(self.accountant)):
          self.args = {}
