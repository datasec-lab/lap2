...
class LapOptimizer(DPOptimizer):
    """
    Implementation of Laplace noise mechanism.
    """
    ...
    def make_noise(self, args):
        self.laplace = Laplace(loc=0, scale=(args['b']))
    ...
    def add_noise(self):
        ...
        for p in self.params:
            ...
            noise = self.laplace.sample(p.size()).to(p.summed_grad.device)
